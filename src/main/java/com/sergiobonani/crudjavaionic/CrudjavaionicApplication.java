package com.sergiobonani.crudjavaionic;
...
public class CrudjavaionicApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(CrudjavaionicApplication.class, args);
	}
